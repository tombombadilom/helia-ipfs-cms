...
const Swirl = ({
  ...
  const simplexRef = useRef<Noise3D>(null)
...
}, [loop, backgroundColor, baseSpeed, baseTTL, center, noiseSteps, particlePropsLength, rangeSpeed, rangeTTL])
...
}, [windowHeight, windowWidth, center])
...
function updateParticle(
  ...
  const noiseFunction: Noise3D = makeNoise3D(i);
